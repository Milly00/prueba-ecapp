...
export class AppHorizontalHeaderComponent {
  ...
  public selectedLanguage: any = {
    ...
    code: 'en',
    type: 'US',
    icon: '/src/assets/images/flag/icon-flag-en.svg',
  };
  ...
  public languages: any[] = [
    ...
    },
    {
      language: 'Español',
      code: 'es',
      icon: '/src/assets/images/flag/icon-flag-es.svg',
    },
    {
      language: 'Français',
      code: 'fr',
      icon: '/src/assets/images/flag/icon-flag-fr.svg',
    },
    {
      language: 'German',
      code: 'de',
      icon: '/src/assets/images/flag/icon-flag-de.svg',
    },
  ];
  ...
  openDialog() {
     this.dialog.open(AppHorizontalSearchDialogComponent);
